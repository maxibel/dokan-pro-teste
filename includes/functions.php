    ...
    if ( 100 === absint( $progress ) ) :
        ...
        switch ( $string ) {
            case 'profile_picture_val':
                ...
                $translated_string = sprintf( __( '<a href="%s">Add Profile Picture</a> to gain %s%% progress', 'dokan' ), untrailingslashit( dokan_get_navigation_url( 'settings/store#dokan-profile-picture-wrapper' ) ), number_format_i18n( $value ) );
                break;

            case 'phone_val':
                // translators: %s%% is the progressbar progress value
                $translated_string = sprintf( __( '<a href="%s">Add Phone</a> to gain %s%% progress', 'dokan' ), untrailingslashit( dokan_get_navigation_url( 'settings/store#setting_phone' ) ), number_format_i18n( $value ) );
                break;

            case 'banner_val':
                // translators: %s%% is the progressbar progress value
                $translated_string = sprintf( __( '<a href="%s">Add Banner</a> to gain %s%% progress', 'dokan' ), untrailingslashit( dokan_get_navigation_url( 'settings/store#dokan-banner-wrapper' ) ), number_format_i18n( $value ) );
                break;

            case 'store_name_val':
                // translators: %s%% is the progressbar progress value
                $translated_string = sprintf( __( '<a href="%s">Add Store Name</a> to gain %s%% progress', 'dokan' ), untrailingslashit( dokan_get_navigation_url( 'settings/store#dokan_store_name' ) ), number_format_i18n( $value ) );
                break;

            case 'address_val':
                // translators: %s%% is the progressbar progress value
                $translated_string = sprintf( __( '<a href="%s">Add address</a> to gain %s%% progress', 'dokan' ), untrailingslashit( dokan_get_navigation_url( 'settings/store#dokan-address-fields-wrapper' ) ), number_format_i18n( $value ) );
                break;

            case 'payment_method_val':
                // translators: %s%% is the progressbar progress value
                $translated_string = sprintf( __( '<a href="%s">Add a Payment method</a> to gain %s%% progress', 'dokan' ), untrailingslashit( dokan_get_navigation_url( 'settings/payment#dokan-payment-methods-listing-wrapper' ) ), number_format_i18n( $value ) );
                break;

            case 'map_val':
                // translators: %s%% is the progressbar progress value
                $translated_string = sprintf( __( '<a href="%s">Add Map location</a> to gain %s%% progress', 'dokan' ), untrailingslashit( dokan_get_navigation_url( 'settings/store#dokan-add-store-location-section' ) ), number_format_i18n( $value ) );
                break;

            case 'fb':
                // translators: %s%% is the progressbar progress value
                $translated_string = sprintf( __( '<a href="%s">Add facebook</a> to gain %s%% progress', 'dokan' ), untrailingslashit( dokan_get_navigation_url( 'settings/social#profile-form' ) ), number_format_i18n( $value ) );
                break;

            case 'twitter':
                // translators: %s%% is the progressbar progress value
                $translated_string = sprintf( __( '<a href="%s">Add Twitter</a> to gain %s%% progress', 'dokan' ), untrailingslashit( dokan_get_navigation_url( 'settings/social#profile-form' ) ), number_format_i18n( $value ) );
                break;

            case 'youtube':
                // translators: %s%% is the progressbar progress value
                $translated_string = sprintf( __( '<a href="%s">Add Youtube</a> to gain %s%% progress', 'dokan' ), untrailingslashit( dokan_get_navigation_url( 'settings/social#profile-form' ) ), number_format_i18n( $value ) );
                break;

            case 'linkedin':
                // translators: %s%% is the progressbar progress value
                $translated_string = sprintf( __( '<a href="%s">Add LinkedIn</a> to gain %s%% progress', 'dokan' ), untrailingslashit( dokan_get_navigation_url( 'settings/social#profile-form' ) ), number_format_i18n( $value ) );
                break;
