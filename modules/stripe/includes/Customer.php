...
class Customer {
    ...
    protected function generate_customer_request() {
        ...
        if ( $user ) {
            ...
            $billing_first_name = isset( $_POST['billing_first_name'] ) ? htmlspecialchars( wp_unslash( $_POST['billing_first_name'] ) ) : ''; // phpcs:ignore WordPress.Security.NonceVerification
            $billing_last_name  = isset( $_POST['billing_last_name'] ) ? htmlspecialchars( wp_unslash( $_POST['billing_last_name'] ) ) : ''; // phpcs:ignore WordPress.Security.NonceVerification
